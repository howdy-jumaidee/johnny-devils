...
export const TOUR_DATES = [
  ...
  },
  {
    ...
    venue: "The Hills Sommarblomster",
    city: "Stockholm",
    country: "Sweden",
    ticket_url: null,
    tickets_pending: false,
...
export const MERCH_ITEMS = [
  ...
  { _uid: "mi3", name: "The Devil's Boots",        price: "2299 KR", image: { filename: "/merch/JD_Devilsboots.webp", alt: "Devil's Boots", position: "center 75%" }, external_url: "#", cta_label: "PRE-ORDER", sold_out: false },
  { _uid: "mi4", name: "Johnny's Belt Buckle", price: "899 KR",  image: { filename: "/merch/JD_Beltbuckle.webp",  alt: "Johnny's Belt Buckle" }, external_url: "#", cta_label: "PRE-ORDER",          sold_out: false },
];
